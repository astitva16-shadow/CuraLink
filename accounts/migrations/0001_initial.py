...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specialization', models.CharField(choices=[('general', 'General Physician'), ('cardiology', 'Cardiologist'), ('dermatology', 'Dermatologist'), ('pediatrics', 'Pediatrician'), ('orthopedics', 'Orthopedic'), ('neurology', 'Neurologist'), ('gynecology', 'Gynecologist'), ('psychiatry', 'Psychiatrist'), ('gastroenterology', 'Gastroenterologist'), ('ent', 'ENT Specialist')], max_length=50)),
